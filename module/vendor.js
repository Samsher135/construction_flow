...
class Vendor {
    ...
    async vendor_contribution(req) {
        ...
        escape_data =["accepted",req.body.id,req.body.type]
    ...
    async get_saved_leads(req) {
        ...
        escape_data =[req.body.id,"acceptedPitch","rejectedPitch","dealClosed"]
    ...
    async vendor_pitched(req) {
        ...
        await notification.setnotification(userid,"New Pitch",`You have recived a new Pitch of worth" ${req.body.pitch_value}`)
    ...
    async vendor_month_sale(req){
        ...
        let escape_data=[req.body.id,"accepted","rejected",req.body.type,start_date,end_date];
    ...
    async no_of_pending_requests_by_type(req,products) {
