...
class Users {
    ...
    async add_feedback(req) {
        ...
        escape_data = [req.body.feedback,req.body.rating,req.body.stars,req.body.id];
        let strQuery = await mysqliClass.mysqli(mysql, 'add_feedback');
        return await global.mysql.query(strQuery, escape_data);
    }
    // async add_feedback(req) {
    //     let mysql = {};
    //     let escape_data = [JSON.stringify(req.body.feedback),req.body.rating,req.body.stars,req.body.id];
    //     let strQuery = await mysqliClass.mysqli(mysql, 'add_feedback');
    //     return await global.mysql.query(strQuery, escape_data);
    // }
    ...
    async construction_material_dropdown() {
        let mysql = {};
        let escape_data = [];
        let strQuery = await mysqliClass.mysqli(mysql, 'construction_material_dropdown');
        return await global.mysql.query(strQuery, escape_data);
    }

    
    async construction_chemical_dropdown() {
        let mysql = {};
        let escape_data = [];
        let strQuery = await mysqliClass.mysqli(mysql, 'construction_chemical_dropdown');
        return await global.mysql.query(strQuery, escape_data);
    }
    ...
    async product_name() {
        let mysql = {};
        let escape_data = [];
        let strQuery = await mysqliClass.mysqli(mysql, 'product_name');
        return await global.mysql.query(strQuery, escape_data);
    }
